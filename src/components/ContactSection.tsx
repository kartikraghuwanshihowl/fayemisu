...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="min-h-screen py-12 sm:py-20 relative">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 dither-reveal -mt-4 px-4">
